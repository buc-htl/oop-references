 ...
 * <p>
 * Eine Referenzvariable kann statt auf ein Objekt auch "ins Nirgendwo" zeigen, in Java ist das die "Null"-Referenz.
 * Attribute, die als Datentyp ein Objekt haben, werden automatisch mit null initialisiert.
 */
...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        /* Die Werte des Objekts, auf das b zeigt, werden gesetzt... */
        b.setVolume(500);
        b.setCurrentLevel(200);

        /* ...und sind natürlich auch für c gültig, weil die beiden Variablen auf das GLEICHE Objekt zeigen. */
